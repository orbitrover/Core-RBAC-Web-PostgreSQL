...
namespace Core.RBAC.Web.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly IUserStore<IdentityUserExtended> _userStore;
        ...
        public ExternalLoginModel(
            ...
            IUserStore<IdentityUserExtended> userStore,
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                IdentityUserExtended user = (IdentityUserExtended)CreateUser();
